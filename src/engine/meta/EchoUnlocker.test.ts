...
describe('evaluateUnlocks', () => {
  ...
  it('unlocks farmers_eye after 2 max-age peasant lives (meta.lineage tracks anchor usage)', () => {
    const meta = {
      ...
      lineage: [
        { lifeIndex: 1, name: 'A', anchorId: 'peasant_farmer', birthYear: 0, deathYear: 90, yearsLived: 90, realmReached: 'mortal', deathCause: 'old_age', karmaEarned: 10, echoesUnlockedThisLife: [], corePath: null, techniquesLearned: [] },
        { lifeIndex: 2, name: 'B', anchorId: 'peasant_farmer', birthYear: 0, deathYear: 88, yearsLived: 88, realmReached: 'mortal', deathCause: 'old_age', karmaEarned: 10, echoesUnlockedThisLife: [], corePath: null, techniquesLearned: [] },
      ],
    };
    const ctx: UnlockContext = {
      meta,
